...
# Set up the URL
base_url = "https://www.avito.ma/fr/maroc/appartements-%C3%A0_vendre?o="
headers = {
...
headers_csv = ['chambres', 'salles_de_bain', 'superficie', 'prix', 'ville', 'titre', 'type']
...
# num to change the url
num = 1

while True:
    response = session.get(base_url+str(num), headers=headers)
    ...
    with open('data.csv', mode='a', newline='', encoding='utf-8') as file:
        ...
        for i in range(len(info)):
            ...
            writer.writerow([chambres, salles_de_bain, superficie, prix, ville, title, 'appartement'])
    print(num)
    num+=1
